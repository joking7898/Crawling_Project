...
#시간 텍스트 추출 함수
def clean_time(text):
    cleaned_text = re.sub('<li><i class="fa fa-clock-o fa-fw"></i>등록일 ', '', text)
...
for i in range(1, 2):
    url = f'https://www.kbmaeil.com/news/articleList.html?page={i}&box_idxno=&sc_sub_section_code=S2N16&sc_section_code=S1N3&view_type=sm'
    r = requests.get(url)
    ...
    for title in news_titles:
        ...
        if href == '':
            ...
            url2 = 'https://www.kbmaeil.com/'+href
